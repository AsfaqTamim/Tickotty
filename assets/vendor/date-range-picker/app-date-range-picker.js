(function () {
	angular.module("app.utils", ['pasvaz.bindonce']);
	angular.module("app.utils").directive('appDateRangePicker', ["$compile", "$timeout", function ($compile, $timeout) {
		var CUSTOM = "CUSTOM";
		...
		function getPickDateTemplate() {
			return '' +
				'<div ng-show="visible" ng-click="handlePickerClick($event)" class="app-daterangepicker">' +
				...
				'</ul>' +
				'<div>' +
				'<button class="btn btn-sm btn-primary" ng-click="applySelection()" ng-disabled="!showCalendars || !currentSelection || !currentSelection.start || !currentSelection.end">Apply</button> ' +
